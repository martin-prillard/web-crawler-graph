...
import fr.paristech.telecom.inf344.crawler.strategy.DFSRobot;


public class GraphExtractionRobot extends DFSRobot {
    ...
    public GraphExtractionRobot(String ua, long delay) {
        super(ua, delay);
